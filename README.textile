__Note: SVSegmentedControl now uses Automatic Reference Counting (ARC). Find the last MRC commit on the "last-mrc":https://github.com/samvermette/SVSegmentedControl/tree/last-mrc branch.__
