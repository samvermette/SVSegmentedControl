__Note: SVSegmentedControl now uses Automatic Reference Counting (ARC). Find the last MRC commit on the "master-mrc":https://github.com/samvermette/SVSegmentedControl/tree/master-mrc branch.__
