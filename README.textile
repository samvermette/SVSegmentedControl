...
SVSegmentedControl is now a UIControl (thanks OliverLetterer) and so you respond to value changes using the usual @addTarget:action:forControlEvents:@ method. Something like:
