...
SVSegmentedControl is now a UIControl (thanks "Oliver Letterer":https://github.com/OliverLetterer) and so you respond to value changes using the usual @addTarget:action:forControlEvents:@ method:
