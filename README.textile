...
*Note*: to customize the thumb's appearance, you'll have to set the properties through SVSegmentedControl's own @thumb@ property. For instance, setting the @tintColor@ is done using:
